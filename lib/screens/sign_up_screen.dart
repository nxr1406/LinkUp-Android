...
class _SignUpScreenState extends State<SignUpScreen> {
  ...
  Future<void> _signUp() async {
    ...
    try {
      ...
      _showError(e.toString().replaceAll('Exception: ', '').replaceAll('[firebase_auth/email-already-in-use]', 'Email already in use'));
    } finally {
      ...
      body: Stack(
        children: [
          ...
          Positioned(
            top: -60,
            right: -40,
            child: _PinkBlob(size: 220),
          ),
          Positioned(
            top: 40,
            right: 80,
            child: _PinkBlob(size: 140, opacity: 0.7),
          ),
          // Bottom pink blobs
          Positioned(
            bottom: -40,
            left: -40,
            child: _PinkBlob(size: 180),
          ),
          Positioned(
            bottom: 60,
            right: -20,
