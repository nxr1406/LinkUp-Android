...
export default function Login() {
  ...
  const isValid = identifier.length > 0 && password.length >= 8;
  ...
  return (
    <div className="flex flex-col h-screen bg-white">
      <div className="flex-1 flex flex-col items-center justify-center px-4">
        ...
        <form onSubmit={handleLogin} className="w-full max-w-sm space-y-3">
          ...
          <div className="flex justify-end pt-1">
            <button type="button" onClick={handleResetPassword} className="text-[12px] font-semibold text-[#0095F6]">
              Forgot password?
            </button>
          </div>
      ...
      <div className="border-t border-[#DBDBDB] py-4 flex justify-center">
