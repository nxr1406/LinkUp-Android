...
import { Menu, Plus, Bell, Lock, Download, LogOut, Trash2, X, Check } from 'lucide-react';
    ...
    <div className="flex flex-col h-full bg-white relative">
      <div className="flex items-center justify-between px-4 h-14 shrink-0">
        <div className="flex items-center">
          ...
          <h1 className="text-[20px] font-bold text-[#262626]">{userData?.username}</h1>
        </div>
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="px-4 py-2 pb-8">
          <div className="flex flex-col items-center mt-6">
            ...
            <h2 className="text-[22px] font-bold text-[#262626] mt-4">{userData?.fullName}</h2>
